...
//!
//! The Ed25519 and X25519 halves of the Device-Bound Post-Quantum family are
//! software components held by the app's envelope machinery; the ML-DSA/ML-KEM
//! halves live in the Secure Enclave. These helpers perform the classical raw
//! scalar operations through the vendored OpenSSL EVP interface — the same
//! provider Sequoia's `crypto-openssl` backend uses — so component outputs are
