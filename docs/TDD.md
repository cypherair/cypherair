...
/Library/Preferences/ (UserDefaults):
  ...
  com.cypherair.tutorial.<UUID>.plist            → tutorial sandbox defaults, prefix-swept on startup/reset if orphaned
