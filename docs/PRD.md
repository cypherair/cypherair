...
backed up" badge. Historical POC planning details are archived in
[APPLE_SECURE_ENCLAVE_CUSTODY](archive/apple-secure-enclave-custody-poc/APPLE_SECURE_ENCLAVE_CUSTODY.md).
