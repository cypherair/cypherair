...
> Status: Active downstream follow-on document for the remaining post-service adoption work on the tracked Rust / FFI capability families.
> Purpose: Record what remains to be built after the current Swift service-layer rollout completed, and prevent already-landed service work from being re-described as future implementation.
