...
> 配套文档：[RUST_FFI_IMPLEMENTATION_REFERENCE](RUST_FFI_IMPLEMENTATION_REFERENCE.md) · [SEQUOIA_CAPABILITY_AUDIT](SEQUOIA_CAPABILITY_AUDIT.md) · [archive/RUST_SEQUOIA_INTEGRATION_TODO](archive/RUST_SEQUOIA_INTEGRATION_TODO.md) · [ARCHITECTURE](ARCHITECTURE.md) · [SECURITY](SECURITY.md) · [TESTING](TESTING.md)
...
- [`RUST_FFI_IMPLEMENTATION_REFERENCE.md`](RUST_FFI_IMPLEMENTATION_REFERENCE.md) 第 3.1 节与 [`archive/RUST_SEQUOIA_INTEGRATION_TODO.md`](archive/RUST_SEQUOIA_INTEGRATION_TODO.md) 第 2.1 节都要求在 Swift 联系人流程中，吸收边界明确的“相同指纹公钥证书更新”。
...
- [`RUST_FFI_IMPLEMENTATION_REFERENCE.md`](RUST_FFI_IMPLEMENTATION_REFERENCE.md) 第 3.2 节与 [`archive/RUST_SEQUOIA_INTEGRATION_TODO.md`](archive/RUST_SEQUOIA_INTEGRATION_TODO.md) 第 2.2 节明确只批准密钥级生产采用。
...
- [`RUST_FFI_IMPLEMENTATION_REFERENCE.md`](RUST_FFI_IMPLEMENTATION_REFERENCE.md) 第 3.3 节与 [`archive/RUST_SEQUOIA_INTEGRATION_TODO.md`](archive/RUST_SEQUOIA_INTEGRATION_TODO.md) 第 2.3 节都允许并期望存在一个专用 Swift 服务包装层，同时将产品 UI 暴露延后。
...
- [`RUST_FFI_IMPLEMENTATION_REFERENCE.md`](RUST_FFI_IMPLEMENTATION_REFERENCE.md) 第 3.4 节与 [`archive/RUST_SEQUOIA_INTEGRATION_TODO.md`](archive/RUST_SEQUOIA_INTEGRATION_TODO.md) 第 2.4 节都说明：默认延后服务层采用。
...
- [`RUST_FFI_IMPLEMENTATION_REFERENCE.md`](RUST_FFI_IMPLEMENTATION_REFERENCE.md) 第 3.5 节与 [`archive/RUST_SEQUOIA_INTEGRATION_TODO.md`](archive/RUST_SEQUOIA_INTEGRATION_TODO.md) 第 2.5 节都将该详细结果能力族记为“增量式能力”，并延后其在生产服务层的采用。
