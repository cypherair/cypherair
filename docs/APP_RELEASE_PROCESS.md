...
7. Open Xcode and archive using `CypherAir AppStore Candidate`.
8. Upload that archive to TestFlight as the App Store candidate validation build.

Do **not** archive the App Store candidate before the GitHub stable release exists.
