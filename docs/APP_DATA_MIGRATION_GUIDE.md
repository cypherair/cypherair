...
| Shared app-data root secret | Keychain default account | `framework-bootstrap` | implemented | Keychain-protected root secret released only through authenticated `LAContext` handoff |
