...
Contacts PR4 covers the protected-domain security, storage, migration/quarantine, recovery, and relock lifecycle for the flat compatibility snapshot. Contacts PR5 adds the person-centered runtime model. Contacts PR6 adds certification projection and saved certification artifacts inside the same protected domain. Remaining later Contacts expansion covers search, tags, recipient lists, and richer package exchange.
