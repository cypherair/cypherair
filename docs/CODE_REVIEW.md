...
- [ ] ProtectedData changes that migrate a persisted surface update `PERSISTED_STATE_INVENTORY.md`, `ARCHITECTURE.md`, `SECURITY.md`, `TDD.md`, `TESTING.md`, and `CODE_REVIEW.md` as needed; update active Contacts docs when Contacts protected-domain behavior, storage, or mutation surfaces are involved, using `CONTACTS_DOC_BRIDGE.md` when content is being moved into long-term docs
