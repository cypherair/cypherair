...
- docs/STORAGE.md — persisted state: protected domains, Keychain rows, the envelope magics (§5), storage target design (§6, roadmap).
...
- docs/WORKFLOW.md — the development loop, verification gates, the documentation contract.
