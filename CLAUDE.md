...
- **Key families:** Key generation uses nine families — Portable Compatible (Profile A software key, GnuPG-compatible), Portable Modern (Profile B / Ed25519 software key, RFC 9580), Portable Modern · High (Ed448+X448 software key, RFC 9580), Portable Post-Quantum (RFC 9980 ML-DSA-65/ML-KEM-768 software key), Portable Post-Quantum · High (RFC 9980 ML-DSA-87/ML-KEM-1024 software key, NIST level 5), Device-Bound Compatible (Secure Enclave custody, P-256 v4, non-exportable), Device-Bound Modern (Secure Enclave custody, P-256 v6, non-exportable), Device-Bound Post-Quantum (RFC 9980 ML-DSA-65/ML-KEM-768 split custody, non-exportable), and Device-Bound Post-Quantum · High (RFC 9980 ML-DSA-87/ML-KEM-1024 split custody, non-exportable). Profile A/B remains the technical vocabulary for the classical software configurations. Product exposure: docs/PRD.md Section 3; custody: docs/SECURE_ENCLAVE_CUSTODY.md; post-quantum design: docs/POST_QUANTUM.md.
