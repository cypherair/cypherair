...
- **Key families:** Key generation offers four families — Portable Compatible (Profile A software key, GnuPG-compatible), Portable Modern (Profile B software key, RFC 9580), and Device-Bound Compatible/Modern (Secure Enclave custody, P-256 v4/v6, non-exportable). Profile A/B remains the technical vocabulary for the software configurations. Device-bound families are release-gated on issue #501 Phases 8–9. See docs/PRD.md Section 3.
