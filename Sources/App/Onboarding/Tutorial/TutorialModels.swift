...
enum TutorialAutomationContract {
    ...
    static let onboardingDecisionReadyMarker = "onboarding.tutorialDecision.ready"
    ...
    static let closeIdentifier = "tutorial.close"
    static let finishIdentifier = "tutorial.finish"
    static let finishToolbarIdentifier = "tutorial.finish.toolbar"
    static let returnToOverviewIdentifier = "tutorial.return"
    static let showGuidanceIdentifier = "tutorial.showGuidance"
    ...
    static let completionPromptPrimaryIdentifier = "tutorial.completionPrompt.primary"
    static let completionPromptKeepExploringIdentifier = "tutorial.completionPrompt.keepExploring"
